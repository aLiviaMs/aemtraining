 ...
 */
MapTo('aemtraining/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('aemtraining/components/separator')(SeparatorV1Component);

MapTo('aemtraining/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('aemtraining/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('aemtraining/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('aemtraining/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('aemtraining/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('aemtraining/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('aemtraining/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('aemtraining/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('aemtraining/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('aemtraining/components/accordion')(AccordionV1Component);
MapTo('aemtraining/components/tabs')(TabsV1Component);
...
LazyMapTo('aemtraining/components/teaser')(TeaserV1Component);
...
LazyMapTo('aemtraining/components/carousel')(CarouselV1Component);
...
LazyMapTo('aemtraining/components/text')(LazyTextModule, TextEditConfig);