...
After running `npm start` **in the `ui.frontend` directory**, your app will be automatically opened in your browser (at path http://localhost:4200/content/aemtraining/us/en/home.html). If you make edits, the page will reload.
